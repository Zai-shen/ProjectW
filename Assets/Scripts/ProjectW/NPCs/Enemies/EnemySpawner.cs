...
{
     public Enemy GingerBreadMan;
     public CinnamonRoll CinnamonRoll;
     ...
     {
         float _randomX = Random.Range(-_mapBounds.x / 2f, _mapBounds.x / 2f);
         float _randomY = Random.Range(0f, 0f);
         float _randomZ = Random.Range(-_mapBounds.z / 2f, _mapBounds.z / 2f);
